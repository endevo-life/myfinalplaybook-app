# AGENTS.md — ENDevo MyFinalPlaybook Mobile App

Project instructions for Codex. These override default behavior.
...
- **100% deterministic. NO Codex API / NO AI generation.** All personalization comes from score calc, band assignment, weakness ranking, and the locked Action Pool. The "Jesse voice" is static band-specific copy via `getJesseWrapper()`. Do not introduce live LLM calls without explicit approval from Niki.
...
- **Never add a Codex co-author trailer** or "Generated with Codex" to commits or PRs.
